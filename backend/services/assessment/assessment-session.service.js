...
const toPublicQuestionByIndex = (session, questionIndex) => {
  ...
  return {
    ...
    cvRelevance: Number(question.cvRelevance || question.cv_relevance || question?.aiMeta?.cv_relevance || 0),
    reasoningWeight: Number(question.reasoningWeight || question.reasoning_weight || question?.aiMeta?.reasoning_weight || 0),
